...
<body>
	...
	<%
		...
		if(su != 0) {
			sendPath = ContextPath + "/BoardV02/jsp/msgChk.jsp?msg=" + URLEncoder.encode("게시글 삭제 완료", "UTF-8");
		} else {
			sendPath = ContextPath + "/BoardV02/jsp/msgChk.jsp?msg=" + URLEncoder.encode("게시글 삭제 실패", "UTF-8");
		}
